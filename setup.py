...
setup(
    ...
    name="seishub.plugins.template_tutorial",
    # The version number of the plugin.
    version="0.0.0",
    # The description of the plugin.
    description="Template and tutorial to derive plugins from.",
    # Your name.
    author="Author Name",
    # Your email.
    ...
    entry_points={"seishub.plugins": [
     "seishub.plugins.template_tutorial = seishub.plugins.template_tutorial",
     ]
    },
)
